    ...
    public class WorldSession : ISession
    {
        ...
        private void onPacketOLD(Opcodes code, byte[] data)
        {
            ...
            if (code == Opcodes.CMSG_PLAYER_LOGIN)
            {
               ...
               sendHexPacket(Opcodes.SMSG_UPDATE_OBJECT, "01 00 00 00" + //Block count
                                                         "00" + //Has transport
                                                         "03" + //Update Type
                                                         "01 01" + //GUID
                                                         "04" + //Object Type
                                                         "71" + //Update flags  (Has_pos + living + All + Self)
                                                         //If hasLiving
                                                            "00 00 00 00" + //Movement flags
                                                            "AD 5E 00 00" + //Time
                                                         //If hasPosition
                                                             //If hasTransport
                                                                 //float posX
