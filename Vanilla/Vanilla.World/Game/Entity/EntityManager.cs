namespace Vanilla.World.Game.Entity
{
    ...
    public class EntityManager
    {
        ...
        public List<ISubscribable> GetEntitiesInRadius(Vector3 location, float radius)
        {
            ...
            entities.AddRange(from entity in this.creatureEntities where (Math.Pow(location.X - entity.Value.Location.X, 2) + Math.Pow(location.Z - entity.Value.Location.Z, 2)) < radiusSquared select entity.Value);
